...
class CustomerRegisterStreamConfiguration(
    ...
    fun customerRegisterStream(): Consumer<CustomerRegisterRequest> {
        return Consumer<CustomerRegisterRequest> { customerRegisterRequest ->
            try {
                val customerRegisterResponse = customerRegisterUseCaseExecutor.execute(customerRegisterRequest)
